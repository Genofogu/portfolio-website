...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for GENO split effect
    const letters = useMemo(() => [
        { char: 'G', baseX: -1.05, splitDir: -1.6, delay: 0 },
        { char: 'E', baseX: -0.37, splitDir: -0.6, delay: 0 },
        { char: 'N', baseX: 0.31, splitDir: 0.6, delay: 0 },
        { char: 'O', baseX: 0.99, splitDir: 1.8, delay: 0 },
    ], []);
