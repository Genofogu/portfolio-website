...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'GENOFOGU', subtitle: '< full-stack engineer & builder />' },
    { id: 'projects', position: [0, 0, -55], type: 'projects', title: 'PRODUCTS', subtitle: 'Inhaby • Rare • Homlap • HourOS' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'EXPLORING', subtitle: 'AI • Data Science • Cloud Systems' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'STACK', subtitle: 'React • Node • Supabase • Three.js • Python' },
];
